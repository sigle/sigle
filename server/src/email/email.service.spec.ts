  ...
  describe('htmlToMJML', () => {
    ...
    it('should convert full article', () => {
      expect(
        ...
        '<mj-text><em>Hot from the press: Sigle 1.5</em></mj-text><mj-text><h2>Sigle x Xverse</h2></mj-text><mj-text>Ever been frustrated not being able to check out new Sigle posts, or write your own, during long metro rides or in waiting rooms? Ever felt like there was nothing left to do but stare at the chipped off paint? Alright, this may be <s>a little</s> dramatic. But being deprived of your favourite content on mobile simply won’t do.</mj-text><mj-text>As we grow and improve Sigle, we want to allow our users to write on the go and read on the bus, and we are excited to announce that Sigle is now featured on the <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.xverse.app/">Xverse app</a>, in the app section!</mj-text><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/Ggryl-wuLF5Lk1_QFrLzw-XVerseXSigle.png" /><mj-text>Xverse is a mobile Stacks compatible wallet that allows you to manage your accounts and access apps through their built-in web browser. Users can also lock their Stacks in the Xverse non-custodial Stacking pool and earn native Bitcoin with zero fees.</mj-text><mj-text><h2>Editor improvements</h2></mj-text><mj-text>This release includes many bug fixes in the editor. And as we strive to give you the best writing experience possible, we’ve also implemented plenty of improvements which we hope you’ll enjoy!</mj-text><mj-text>We’ve made some writing blocks context-aware, to help you write faster and execute quick actions. Also, not only can you now <strong>drag and drop images</strong> directly into the editor, you can embed tweets in your articles with <strong>Twitter blocks</strong>!</mj-text><mj-text><h2>Changelog Sigle 1.5</h2></mj-text><mj-list><mj-li>Added <strong>Twitter embeds</strong> to the editor.</mj-li></mj-list><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/vjyOifZ3XNEOrtnDGWfV5-final.png" /><mj-list><mj-li>The editor now <strong>works on mobile</strong>.</mj-li></mj-list><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/ngUQ5NSE55EUi-WpuE1ts-Frame%20286.png" /><mj-list><mj-li>Added <strong>drag-and-drop support</strong> to the editor.</mj-li><mj-li>Improved drag-and-drop experience for the cover image.</mj-li></mj-list><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/tzAo1G4LiTsgWdRlXgzWK-triptolisbon.png" /><mj-text></mj-text><mj-list><mj-li>Many changes to the interface to make the website <strong>responsive on mobile</strong>.</mj-li><mj-li>Fixed an issue causing articles not to be correctly indexed by crawlers.</mj-li><mj-li>Many small bug fixes across the app.</mj-li></mj-list><mj-text>See the full list of changes <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/sigle/sigle/releases/tag/%40sigle%2Fapp%401.5.0">here</a>.</mj-text><mj-text><h2>The Explorer Guild Birthday</h2></mj-text><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/0TwJ6ctL9x4t1jxdzuMPv-Pen%20Run_1.png" /><mj-text>This may be hard to believe, but the Explorer Guild is celebrating their first birthday! To mark the occasion, we’ve put together our very first <a target="_blank" rel="noopener noreferrer nofollow" href="https://app.sigle.io/sigleapp.id.blockstack/h8Kxgg9_Ck6f0V-YgB7Gz">Pen Run Contest</a>, don’t forget to join for a chance to win our very first 1/1 NFT!</mj-text><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/aZnSwTcYu2hjtk22FwVCR-Wizard%20explorer%20(1).gif" /><mj-text>We also want to thank all of our holders and community for supporting us and allowing us to build Sigle for over a year. We’re excited for what’s ahead of us, and can’t wait to continue the adventure with you by our sides. In the meantime, why not take a walk down memory lane in the <a target="_blank" rel="noopener noreferrer nofollow" href="https://museum.explorerguild.io/">Explorer Guild Museum</a>?</mj-text><mj-text><h2>Explorers keep exploring</h2></mj-text><mj-image src="https://gaia.blockstack.org/hub/1KwTnsTj6Rqm26zRfhJuNdQUG63ieozxbB/photos/yCsXl0hAEomHW571dqCiG-Capture%20d%E2%80%99e%CC%81cran%202022-11-01%20a%CC%80%2014.54.30.png" /><mj-text>The Explorer Guild is placed as the 12th most traded project on STX, with over 177k STX of volume. We’re also very excited to see our floor price go back up, almost reaching 100 STX.</mj-text><mj-text><h2>What’s next</h2></mj-text><mj-text>As we strive to make our user experience as seamless as possible, it’s important to us that old and new users understand where they’re going when they reach the platform. The next release will focus on <strong>improving the onboarding experience</strong> even more.</mj-text><mj-text><strong>Newsletter features will also be top of mind over the next few months.</strong> We want to allow our writers to create direct communication channels with their audiences, to help them grow and expand their communities.</mj-text><mj-text>The Sigle team 📝</mj-text>',
      );
    });
  });
